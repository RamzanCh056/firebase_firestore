...
class _SplashScreenState extends State<SplashScreen> {
  ...
  void initState() {
    Future.delayed(const Duration(seconds: 3), () {
      Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (_) => AddShowData()), (route) => false);
    });
    super.initState();
  }
  ...
  String intTo8bitString(int number, {bool prefix = false}) =>
      prefix ? '0x${number.toRadixString(2).padLeft(19, '0')}' : '${number.toRadixString(2).padLeft(19, '0')}';
}
